...
It is assummed that the first line of the log file contains the pattern that was used to  format 
the output. See http://logback.qos.ch/manual/encoders.html#outputPatternAsHeader for further 
details.

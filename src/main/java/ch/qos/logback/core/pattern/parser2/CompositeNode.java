 ...
 * @hidden
 */
class CompositeNode extends SimpleKeywordNode {
  Node childNode;
  ...
  CompositeNode(String keyword, int position) {
    super(Node.COMPOSITE_KEYWORD, keyword, position);
  }
  ...
  public String toString() {
    ...
    if (childNode != null) {
      buf.append("@" + position).append("CompositeNode(" + childNode + ")");
    } else {

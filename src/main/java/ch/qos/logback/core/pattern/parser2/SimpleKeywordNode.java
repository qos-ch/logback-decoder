 ...
 * @hidden
 */
class SimpleKeywordNode extends FormattingNode {
  ...
  SimpleKeywordNode(Object value, int position) {
    super(Node.SIMPLE_KEYWORD, value, position);
  }
  ...
  protected SimpleKeywordNode(int type, Object value, int position) {

...
class Token {
  ...
  static public final int UNSPECIFIED_POSITION = -1;
  ...
  public Token(int type) {
    this(type, null, UNSPECIFIED_POSITION);
  }

  public Token(int type, Object value) {
	  this(type, value, UNSPECIFIED_POSITION);
  }
  
  public Token(int type, Object value, int position) {
    this.type = type;
    this.value = value;
  ...
  public String toString() {
    ...
    if (value == null) {
      return "@" + position + "Token(" + typeStr + ")";

    } else {
      return "@" + position + "Token(" + typeStr + ", \"" + value + "\")";
    }
  }
